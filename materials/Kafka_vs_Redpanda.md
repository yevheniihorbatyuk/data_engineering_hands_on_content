- [[#📊 Швидкий огляд|📊 Швидкий огляд]]
- [[#🏗️ Архітектура та основні концепції|🏗️ Архітектура та основні концепції]]
	- [[#🏗️ Архітектура та основні концепції#Apache Kafka|Apache Kafka]]
	- [[#🏗️ Архітектура та основні концепції#Redpanda|Redpanda]]
- [[#🚀 Продуктивність та ресурси (benchmarks 2025)|🚀 Продуктивність та ресурси (benchmarks 2025)]]
	- [[#🚀 Продуктивність та ресурси (benchmarks 2025)#Порівняння Throughput|Порівняння Throughput]]
	- [[#🚀 Продуктивність та ресурси (benchmarks 2025)#Порівняння Latency|Порівняння Latency]]
	- [[#🚀 Продуктивність та ресурси (benchmarks 2025)#Використання ресурсів|Використання ресурсів]]
- [[#⚡ Новини в Kafka 3.8+ (режим KRaft)|⚡ Новини в Kafka 3.8+ (режим KRaft)]]
	- [[#⚡ Новини в Kafka 3.8+ (режим KRaft)#Що змінилося без ZooKeeper|Що змінилося без ZooKeeper]]
	- [[#⚡ Новини в Kafka 3.8+ (режим KRaft)#Переваги KRaft|Переваги KRaft]]
	- [[#⚡ Новини в Kafka 3.8+ (режим KRaft)#Недоліки KRaft (станом на 2025)|Недоліки KRaft (станом на 2025)]]
- [[#🔐 Порівняння безпеки|🔐 Порівняння безпеки]]
	- [[#🔐 Порівняння безпеки#Authentication та Authorization|Authentication та Authorization]]
	- [[#🔐 Порівняння безпеки#Шифрування|Шифрування]]
	- [[#🔐 Порівняння безпеки#Відповідність стандартам|Відповідність стандартам]]
- [[#🌐 Cloud-Native та Kubernetes|🌐 Cloud-Native та Kubernetes]]
	- [[#🌐 Cloud-Native та Kubernetes#Інтеграція з Kubernetes|Інтеграція з Kubernetes]]
	- [[#🌐 Cloud-Native та Kubernetes#Керовані хмарні сервіси|Керовані хмарні сервіси]]
	- [[#🌐 Cloud-Native та Kubernetes#Стратегія мультихмари|Стратегія мультихмари]]
- [[#🔧 Екосистема та інтеграції|🔧 Екосистема та інтеграції]]
	- [[#🔧 Екосистема та інтеграції#Основна екосистема|Основна екосистема]]
	- [[#🔧 Екосистема та інтеграції#Матриця інтеграції|Матриця інтеграції]]
	- [[#🔧 Екосистема та інтеграції#Екосистема конекторів|Екосистема конекторів]]
- [[#📊 Порівняння продвинутих функцій|📊 Порівняння продвинутих функцій]]
	- [[#📊 Порівняння продвинутих функцій#Tiered Storage|Tiered Storage]]
	- [[#📊 Порівняння продвинутих функцій#Multi-tenancy|Multi-tenancy]]
	- [[#📊 Порівняння продвинутих функцій#Географічна реплікація|Географічна реплікація]]
- [[#💰 Загальна вартість володіння (2025)|💰 Загальна вартість володіння (2025)]]
	- [[#💰 Загальна вартість володіння (2025)#Витрати на інфраструктуру|Витрати на інфраструктуру]]
	- [[#💰 Загальна вартість володіння (2025)#Операційні витрати|Операційні витрати]]
	- [[#💰 Загальна вартість володіння (2025)#Приховані витрати|Приховані витрати]]
- [[#🔄 Стратегії міграції|🔄 Стратегії міграції]]
	- [[#🔄 Стратегії міграції#Підходи до міграції|Підходи до міграції]]
	- [[#🔄 Стратегії міграції#Хронологія міграції|Хронологія міграції]]
	- [[#🔄 Стратегії міграції#Інструменти міграції|Інструменти міграції]]
	- [[#🔄 Стратегії міграції#Шаблон міграції без простоїв|Шаблон міграції без простоїв]]
- [[#🏢 Реальні випадки використання та кейси|🏢 Реальні випадки використання та кейси]]
	- [[#🏢 Реальні випадки використання та кейси#Enterprise впровадження|Enterprise впровадження]]
		- [[#Enterprise впровадження#Історії успіху Kafka|Історії успіху Kafka]]
		- [[#Enterprise впровадження#Історії успіху Redpanda|Історії успіху Redpanda]]
	- [[#🏢 Реальні випадки використання та кейси#Рекомендації за випадками використання|Рекомендації за випадками використання]]
- [[#🐛 Усунення проблем та налаштування продуктивності|🐛 Усунення проблем та налаштування продуктивності]]
	- [[#🐛 Усунення проблем та налаштування продуктивності#Поширені проблеми|Поширені проблеми]]
		- [[#Поширені проблеми#Проблеми Kafka|Проблеми Kafka]]
		- [[#Поширені проблеми#Проблеми Redpanda|Проблеми Redpanda]]
	- [[#🐛 Усунення проблем та налаштування продуктивності#Посібник з налаштування продуктивності|Посібник з налаштування продуктивності]]
		- [[#Посібник з налаштування продуктивності#Налаштування Kafka|Налаштування Kafka]]
		- [[#Посібник з налаштування продуктивності#Налаштування Redpanda|Налаштування Redpanda]]
	- [[#🐛 Усунення проблем та налаштування продуктивності#Кращі практики моніторингу|Кращі практики моніторингу]]
- [[#🎯 Framework для прийняття рішень|🎯 Framework для прийняття рішень]]
	- [[#🎯 Framework для прийняття рішень#Матриця технічних рішень|Матриця технічних рішень]]
	- [[#🎯 Framework для прийняття рішень#Ситуаційні рекомендації|Ситуаційні рекомендації]]
		- [[#Ситуаційні рекомендації#Обирайте Kafka коли:|Обирайте Kafka коли:]]
		- [[#Ситуаційні рекомендації#Обирайте Redpanda коли:|Обирайте Redpanda коли:]]
	- [[#🎯 Framework для прийняття рішень#Дерево рішень міграції|Дерево рішень міграції]]
- [[#🔮 Майбутня дорожня карта (2025-2027)|🔮 Майбутня дорожня карта (2025-2027)]]
	- [[#🔮 Майбутня дорожня карта (2025-2027)#Дорожня карта Kafka|Дорожня карта Kafka]]
	- [[#🔮 Майбутня дорожня карта (2025-2027)#Дорожня карта Redpanda|Дорожня карта Redpanda]]
	- [[#🔮 Майбутня дорожня карта (2025-2027)#Промислові тенденції|Промислові тенденції]]
- [[#📚 Навчальні ресурси|📚 Навчальні ресурси]]
	- [[#📚 Навчальні ресурси#Офіційна документація|Офіційна документація]]
	- [[#📚 Навчальні ресурси#Навчальні ресурси|Навчальні ресурси]]
	- [[#📚 Навчальні ресурси#Ресурси спільноти|Ресурси спільноти]]
	- [[#📚 Навчальні ресурси#Практичні лабораторні роботи|Практичні лабораторні роботи]]
- [[#🔍 Практичні поради для українських команд|🔍 Практичні поради для українських команд]]
	- [[#🔍 Практичні поради для українських команд#Враховуючи український контекст:|Враховуючи український контекст:]]
- [[#✅ Висновки та стратегічні рекомендації|✅ Висновки та стратегічні рекомендації]]
	- [[#✅ Висновки та стратегічні рекомендації#Реальність 2025 року|Реальність 2025 року]]
	- [[#✅ Висновки та стратегічні рекомендації#Стратегічні вказівки|Стратегічні вказівки]]
	- [[#✅ Висновки та стратегічні рекомендації#Фінальна рекомендація|Фінальна рекомендація]]
	- [[#✅ Висновки та стратегічні рекомендації#Рекомендації для різних типів організацій|Рекомендації для різних типів організацій]]
- [[#🚀 Наступні кроки|🚀 Наступні кроки]]
	- [[#🚀 Наступні кроки#Для тих хто досліджує:|Для тих хто досліджує:]]
	- [[#🚀 Наступні кроки#Для тих хто планує міграцію:|Для тих хто планує міграцію:]]
	- [[#🚀 Наступні кроки#Для прийняття рішень:|Для прийняття рішень:]]
